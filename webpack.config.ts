...

  {
    ...
    externals: {
      ...
      "@xterm/addon-unicode11":
        'require("../node_modules/@xterm/addon-unicode11/lib/addon-unicode11.js")',
      ...
      "@xterm/addon-fit":
        'require("../node_modules/@xterm/addon-fit/lib/addon-fit.js")',
      "@xterm/addon-image":
        'require("../node_modules/@xterm/addon-image/lib/addon-image.js")',
      "@xterm/addon-search":
        'require("../node_modules/@xterm/addon-search/lib/addon-search.js")',
      "@xterm/addon-web-links":
        'require("../node_modules/@xterm/addon-web-links/lib/addon-web-links.js")',
      "@xterm/addon-webgl":
        'require("../node_modules/@xterm/addon-webgl/lib/addon-webgl.js")',
      ...
      ...(isProd
        ...
        : [
            codeInspectorPlugin({
              bundler: "webpack",
              dev: true,
              // Floating switch: terminal apps often compete with hotkeys; see https://inspector.fe-dev.cn/en/guide/start.html
              showSwitch: true,
              hideConsole: false,
              ...(process.platform === "darwin"
                ? ({ launchType: "open", showSwitch: true } as const)
                : {}),
            }),
          ]),
    ],
