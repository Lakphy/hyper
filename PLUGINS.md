...
In dev mode you'll get more ouput, and Hyper will try to load React/Redux dev-tools in Electron when they are available.
If extension installation fails, Hyper still starts and the built-in Chromium dev-tools remain available.
